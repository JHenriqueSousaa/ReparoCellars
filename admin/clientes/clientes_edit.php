...
if($_SERVER["REQUEST_METHOD"]=="POST") {
    ...
    */
    ...
    if(empty($idCliente)) {
        ...
        $query = "update clientes set nome='$nomeCliente', morada='$moradaCliente', telemovel='$telemovelCliente', email='$emailCliente', obs='$obsCliente' where idCliente= '$idCliente'";
        ...
        if($resultado) {
            header("location: clientes_lista.php?msg=2");
        }
    }
}
